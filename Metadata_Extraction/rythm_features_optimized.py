...
SHORT_TO_FULL = {
    ...
    "sync": "Syncopation Low to High",
    "backbeat": "Backbeat",
    "dance": "Danceability",
}

SYSTEM_PROMPT = (
    "Rate MGPHot rhythm features from Oramas et al. 2025. "
...
def build_prompt(batch_df: pd.DataFrame) -> str:
    ...
    return (
        "Fields: tempo,cut,triple,compound,odd,swing,shuffle,sync,backbeat,dance\n"
        '{"results":[{"id":0,"tempo":0,"cut":0,"triple":0,"compound":0,"odd":0,"swing":0,"shuffle":0,"sync":0,"backbeat":0,"dance":0}]}\n'
        f"{songs_block}"
    )
