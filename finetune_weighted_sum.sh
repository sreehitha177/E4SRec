...
#SBATCH --output=logs/finetune_weighted_sum_%j.log
#SBATCH --error=logs/finetune_weighted_sum_%j.err
...
OUTPUT_DIR="/project/pi_dagarwal_umass_edu/project_7/snarayana/checkpoints/SASRec_audio_lyric_weighted_sum"
MAX_STEPS="${MAX_STEPS:--1}"
# Per-modality projections (SASRec→64, audio→64, lyric→64) are all trained.
# Fusion weights are also learned (nn.Parameter) — no fixed_weights for finetuning.
