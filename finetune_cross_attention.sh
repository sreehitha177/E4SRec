...
#SBATCH --output=logs/finetune_cross_attention_%j.log
#SBATCH --error=logs/finetune_cross_attention_%j.err
...
OUTPUT_DIR="/project/pi_dagarwal_umass_edu/project_7/snarayana/checkpoints/SASRec_audio_lyric_cross_attention"
MAX_STEPS="${MAX_STEPS:--1}"
# SASRec queries attend over audio + lyric key/values; output projected to 64-dim.
