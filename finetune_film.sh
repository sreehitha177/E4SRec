...
#SBATCH --output=logs/finetune_film_%j.log
#SBATCH --error=logs/finetune_film_%j.err
...
OUTPUT_DIR="/project/pi_dagarwal_umass_edu/project_7/snarayana/checkpoints/SASRec_audio_lyric_film"
MAX_STEPS="${MAX_STEPS:--1}"
# Audio+lyric conditioner produces scale and shift applied to SASRec embedding.
